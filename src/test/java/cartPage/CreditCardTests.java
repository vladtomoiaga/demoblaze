...
public class CreditCardTests extends BaseTests {
    @Test
    public void testNotSuccessfulCreditNumberShort() {
        ...
        // Fill in Credit Card
        cartPage.setCreditCard(CREDIT_CARD_NUMBER_SHORT);
        // Verify if the length of the card is less than 16
        assertNotEquals(String.valueOf(CREDIT_CARD_NUMBER_SHORT).length(), 16);
    ...
    @Test
    public void testNotSuccessfulCreditNumberLong() {
        // Click on the Home button
        homePage.clickHome();
        // Click on the Phone button
        HomePage phones = homePage.clickPhones();
        ...
        assertTrue(cityBoolean(CITY), "Enter a valid city");
        // Fill in Credit Card
        cartPage.setCreditCard(CREDIT_CARD_NUMBER_LONG);
        // Verify if the length of the card is more than 16
        assertNotEquals(String.valueOf(CREDIT_CARD_NUMBER_LONG).length(), 16);
        // Click on the Close button
        cartPage.clickCloseButton();
        // Click on the Delete button
        cartPage.clickDeleteButton(0);
